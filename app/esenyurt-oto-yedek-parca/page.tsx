...
export const metadata: Metadata = {
  title: "Esenyurt Oto Yedek Parça | Jade Automotive",
  description:
    "Esenyurt ve çevresinde oto yedek parça arayanlar için fren, filtre, ön takım, süspansiyon, motor ve bakım parçaları. Marka, model ve yıl bilgisini WhatsApp'tan gönderin.",
  alternates: {
    canonical: "https://www.frenbalataci.com.tr/esenyurt-oto-yedek-parca",
  },
};

const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%20Jade%20Automotive%20%F0%9F%91%8B%0AEsenyurt%20ve%20%C3%A7evresinden%20oto%20yedek%20par%C3%A7a%20bak%C4%B1yorum.%0A%0AMarka%20%2F%20Model%3A%20%0AY%C4%B1l%3A%20%0AMotor%3A%20%0AArad%C4%B1%C4%9F%C4%B1m%20Par%C3%A7a%3A%20";
...
const categories = [
  ...
  },
  {
    icon: "🛞",
    title: "Süspansiyon",
    text: "Amortisör, amortisör takozu, rulman ve süspansiyon parçaları.",
  },
  {
    icon: "🌬️",
    title: "Filtreler",
  ...
  },
  {
    ...
    text: "Triger seti, devirdaim pompası, termostat ve ilgili motor parçaları.",
  },
  {
    icon: "🚗",
...
const faq = [
  {
    q: "Esenyurt oto yedek parça arıyorum, nasıl parça sorabilirim?",
    a: "Araç marka, model, üretim yılı, motor ve aradığınız parçayı WhatsApp üzerinden Jade Automotive'e gönderebilirsiniz.",
  },
  {
    q: "Parçanın adını bilmiyorsam ne yapmalıyım?",
    a: "Elinizde varsa eski parçanın, kutunun veya parça kodunun fotoğrafını WhatsApp üzerinden gönderebilirsiniz. Araç bilgilerinizi de eklemeniz parça araştırmasını kolaylaştırır.",
  },
  {
    q: "Her araç modeline aynı yedek parça olur mu?",
    a: "Hayır. Aynı model araçlarda bile üretim yılı, motor tipi ve donanıma göre farklı yedek parçalar kullanılabilir. Bu nedenle araç bilgilerinin kontrol edilmesi önemlidir.",
  },
  {
    q: "Hangi oto yedek parça grupları için bilgi alabilirim?",
    a: "Fren, filtre, ön takım, süspansiyon, debriyaj, triger, devirdaim ve farklı bakım veya motor parçaları için araç bilgilerinizi göndererek uygunluk hakkında bilgi alabilirsiniz.",
  },
];
    ...
    <>
      ...
      <main className="min-h-screen bg-[#07111d] text-white">
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="absolute -left-32 bottom-0 h-80 w-80 rounded-full bg-[#25D366]/5 blur-3xl" />

          <div className="relative mx-auto max-w-6xl px-5 py-16 md:py-24">
            <div className="mb-6 flex flex-wrap gap-2 text-sm text-slate-400">
              <Link href="/">Ana Sayfa</Link>
              <span>›</span>
              <span className="text-cyan-300">Esenyurt Oto Yedek Parça</span>
            </div>

            <span className="inline-flex rounded-full border border-[#25D366]/30 bg-[#25D366]/10 px-4 py-2 text-sm font-bold text-[#62e893]">
              💬 Aradığın parçayı bulamadın mı? Bize yaz
            </span>

            <h1 className="mt-6 max-w-5xl text-4xl font-black leading-tight md:text-6xl">
              Esenyurt{" "}
              <span className="text-cyan-300">Oto Yedek Parça</span>
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Esenyurt ve çevresinde aracın için yedek parça mı arıyorsun?
              Parça kodları arasında kaybolmana gerek yok.{" "}
              <strong className="text-white">
                Marka, model, yıl ve aradığın parçayı
              </strong>{" "}
              bize gönder. Aracına uygun parçayı bulmana yardımcı olalım.
            </p>
            ...
            <div className="mt-8 max-w-2xl rounded-3xl border border-[#25D366]/30 bg-[#25D366]/10 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-black">
                    “Parçanın kodunu bilmiyorum.”
                  </h2>
                  <p className="mt-2 leading-7 text-slate-300">
                    Sorun değil. Aracını ve aradığın parçayı söylemen yeterli.
                  </p>
                </div>
              </div>
              ...
              >
                💬 WhatsApp'tan Yedek Parça Sor
              </a>

              <p className="mt-3 text-center text-xs text-slate-400">
                Hazır mesaj açılır. Araç bilgilerini doldurup gönderebilirsin.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-5 py-16">
          <div className="text-center">
            <span className="font-black text-cyan-300">
              YEDEK PARÇA BULMAK KOLAY
            </span>

            <h2 className="mt-3 text-3xl font-black md:text-4xl">
              Aracını söyle, parçanı sor
            </h2>

            <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-400">
              Uzun formlar doldurmak yerine birkaç araç bilgisini
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ["🚗", "Marka / Model", "Örn. Renault Clio"],
              ["📅", "Üretim Yılı", "Örn. 2020"],
              ["⚙️", "Motor", "Örn. 1.5 dCi"],
              ["🔎", "Aradığın Parça", "Örn. Fren Balatası"],
        ...
        <section className="border-y border-white/10 bg-[#0a1928]">
          <div className="mx-auto max-w-6xl px-5 py-16">
            ...
            <p className="mt-4 max-w-3xl leading-7 text-slate-400">
              Esenyurt ve çevresinde farklı araç yedek parçaları için araç
              bilgilerini göndererek parça uygunluğu hakkında bilgi
              alabilirsin.
            </p>
            ...
            <div className="mt-9 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {categories.map((item) => (
                <article
                  key={item.title}
                  className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 transition hover:-translate-y-1 hover:border-cyan-400/30"
                >
            ...
            <div className="grid items-center gap-8 md:grid-cols-[1fr_auto]">
              <div>
                ...
                <h2 className="mt-2 max-w-3xl text-3xl font-black md:text-4xl">
                  Parçanın adını bile bilmiyorsan bize yaz 👋
                </h2>
                <p className="mt-4 max-w-2xl font-medium leading-7">
                  Elinde eski parçanın fotoğrafı, kutusu veya parça kodu varsa
                  gönder. Yoksa sadece araç bilgilerini ve ne aradığını anlat.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-6xl px-5 pb-16">
          <div className="grid gap-10 lg:grid-cols-2">
            <article>
              <span className="font-black text-cyan-300">
                DOĞRU PARÇA NEDEN ÖNEMLİ?
              </span>

              <h2 className="mt-3 text-3xl font-black">
                Aynı model araçta bile parça değişebilir
              </h2>

              <p className="mt-5 leading-8 text-slate-300">
                Oto yedek parça seçiminde yalnızca aracın marka ve modelini
                bilmek her zaman yeterli olmayabilir. Aynı modelin farklı
                üretim yıllarında veya farklı motor seçeneklerinde farklı
                parçalar kullanılabilir.
              </p>

              <p className="mt-4 leading-8 text-slate-300">
                Bu nedenle araç marka, model, üretim yılı ve motor bilgisini
                paylaşmak doğru parçanın araştırılmasını kolaylaştırır.
              </p>
            </article>
        ...
        <section className="border-y border-white/10 bg-[#0a1928]">
          <div className="mx-auto max-w-6xl px-5 py-16">
            ...
            <h2 className="mt-3 text-3xl font-black">
              Aracında hangi bölge için parça arıyorsun?
            </h2>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Link
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:border-cyan-400/30"
              >
                <strong className="text-cyan-300">Fren Diski →</strong>
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Fren diski ve balata-disk ilişkisi.
                </p>
              </Link>
              ...
              <Link
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:border-cyan-400/30"
              >
                <strong className="text-cyan-300">Filtre Seti →</strong>
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Yağ, hava, polen ve yakıt filtreleri.
                </p>
              </Link>
              ...
              <Link
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:border-cyan-400/30"
              >
                <strong className="text-cyan-300">Ön Takım →</strong>
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Rot başı, rotil, salıncak ve Z rot parçaları.
                </p>
              </Link>
              ...
              <Link
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:border-cyan-400/30"
              >
                <strong className="text-cyan-300">Amortisör →</strong>
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Amortisör ve süspansiyon parçaları.
                </p>
              </Link>
              ...
              <Link
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:border-cyan-400/30"
              >
                <strong className="text-cyan-300">Triger Seti →</strong>
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Triger sistemi ve ilgili yedek parçalar.
                </p>
              </Link>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-6xl px-5 py-16">
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
            ...
            <p className="mt-3 text-slate-400">
              Aradığın parçayı mağazalarda göremiyorsan WhatsApp üzerinden
        ...
        <section className="px-5 pb-20">
          <div className="mx-auto max-w-6xl rounded-[36px] border border-[#25D366]/20 bg-gradient-to-br from-[#25D366]/10 to-cyan-400/10 p-8 text-center md:p-14">
            ...
            <h2 className="mx-auto mt-5 max-w-4xl text-3xl font-black md:text-5xl">
              Esenyurt'ta oto yedek parça mı arıyorsun?
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">
              Aracının bilgilerini ve aradığın parçayı gönder. Jade Automotive
              olarak uygun parçayı bulmana yardımcı olalım.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-500">
              Marka • Model • Yıl • Motor • Aradığın Parça
            </p>
          </div>
        </section>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/10 bg-[#07111d]/95 p-3 backdrop-blur md:hidden">
        ...
        >
          💬 Aracıma Uygun Yedek Parçayı Sor
        </a>
      </div>
    </>
  );
