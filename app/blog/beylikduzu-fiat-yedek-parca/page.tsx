...
export const metadata: Metadata = {
  title: "Beylikdüzü Fiat Yedek Parça | Jade Automotive",
  description:
    "Beylikdüzü Fiat yedek parça arayanlar için fren balatası, filtre, debriyaj, süspansiyon, motor ve elektrik parçaları. Aracınıza uygun Fiat yedek parça için Jade Automotive ile iletişime geçin.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/beylikduzu-fiat-yedek-parca",
  },
  robots: {
    index: true,
    follow: true,
...
const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%2C%20Beylikd%C3%BCz%C3%BC%20Fiat%20yedek%20par%C3%A7a%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum.";

const parts = [
  {
    title: "Fren Sistemi",
    text: "Fren balatası ve fren sistemi parçaları için aracınıza uygun seçenekleri araştırabilirsiniz.",
  },
  {
    title: "Filtreler",
    text: "Yağ, hava, polen ve yakıt filtreleri gibi periyodik bakım parçaları.",
  },
  {
    title: "Debriyaj",
    text: "Debriyaj sistemi ve ilgili parçalar için araç bilgilerinize göre araştırma yapabilirsiniz.",
  },
  {
    title: "Süspansiyon",
    text: "Amortisör, salıncak ve diğer süspansiyon sistemi parçaları.",
  },
  {
    title: "Motor Parçaları",
    text: "Bakım ve onarım ihtiyaçlarına yönelik çeşitli motor parçaları.",
  },
  {
    title: "Elektrik & Ateşleme",
    text: "Araç elektrik ve ateşleme sistemlerinde kullanılan yedek parçalar.",
  },
];
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-16 lg:px-8 lg:pb-28 lg:pt-24">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300 sm:text-xl">
              Beylikdüzü ve çevresinde Fiat aracınız için yedek parça
              arıyorsanız, ihtiyacınız olan parçayı araç bilgilerinize göre
              araştırabilir ve Jade Automotive üzerinden bilgi alabilirsiniz.
            </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400">
              Fiat Parça Arayanlara
            </p>

            <h2 className="text-3xl font-black sm:text-4xl">
              Fiat aracınız için doğru yedek parçayı bulun
            </h2>

            <div className="mt-7 space-y-5 text-base leading-8 text-slate-300">
              <p>
                Fiat yedek parça ararken yalnızca parçanın adına bakmak yeterli
                olmayabilir. Araç modeli, model yılı, motor seçeneği ve parçanın
                teknik özellikleri doğru ürünün belirlenmesinde önem taşıyabilir.
              </p>

              <p>
                Bu nedenle Beylikdüzü Fiat yedek parça aramalarında aracınızın
                bilgilerini paylaşarak ihtiyacınıza uygun parçayı araştırmak
                daha sağlıklı bir yöntemdir.
              </p>

              <p>
                Jade Automotive ile fren sistemi, filtreler, debriyaj,
                süspansiyon, motor ve elektrik gruplarındaki yedek parçalar
      ...
      <section className="border-y border-white/10 bg-[#081827]">
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400">
              Fiat Yedek Parça Grupları
            </p>

            <h2 className="text-3xl font-black sm:text-4xl">
              Hangi Fiat yedek parçalarını arıyorsunuz?
            </h2>

            <p className="mt-5 leading-8 text-slate-300">
              Fiat aracınızın bakım veya onarım ihtiyacına göre farklı yedek
              parça gruplarında araştırma yapabilirsiniz.
            </p>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black sm:text-4xl">
                Fiat fren balatası mı arıyorsunuz?
              </h2>

              <p className="mt-5 max-w-3xl leading-8 text-slate-300">
                Fren balatası gibi güvenlik açısından önemli parçalarda
                aracınıza uygun ürünün belirlenmesi önemlidir. Fiat modeliniz
                ve araç bilgilerinizi paylaşarak ihtiyacınız olan parça
                hakkında bilgi alabilirsiniz.
              </p>
            </div>
      ...
      <section className="border-y border-white/10 bg-[#081827]">
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-black sm:text-4xl">
              Fiat yedek parça fiyatını nasıl öğrenebilirsiniz?
            </h2>

            <p className="mt-5 leading-8 text-slate-300">
              Yedek parça fiyatı parçanın türüne ve araç uygulamasına göre
              değişebilir. Bu nedenle sabit bir fiyat yerine aracınıza özel
              bilgi almak daha doğru sonuç verir.
            </p>
          </div>
            ...
            {[
              {
                ...
                text: "Fiat modelinizi ve model yılınızı paylaşın.",
              },
              {
                number: "02",
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.06] p-8">
            ...
            <h2 className="mt-3 text-3xl font-black">
              Fiat parçanızı sorun
            </h2>

            <p className="mt-5 leading-8 text-slate-300">
              Fiat aracınızın modelini, yılını ve aradığınız parçayı
              WhatsApp üzerinden iletin. İhtiyacınız olan yedek parça
              hakkında bilgi alabilirsiniz.
            </p>
      ...
      <section className="border-t border-white/10 bg-[#040c16]">
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-8 lg:py-24">
          ...
          <div className="mt-10 space-y-4">
            {[
              {
                q: "Beylikdüzü'nde Fiat yedek parça nereden alınır?",
                a: "Beylikdüzü ve çevresinde Fiat yedek parça arıyorsanız Jade Automotive ile iletişime geçerek aracınıza uygun parça hakkında bilgi alabilirsiniz.",
              },
              {
                q: "Fiat yedek parça fiyatları neden değişir?",
                a: "Parçanın türü, araç modeli, model yılı, teknik özellikleri ve tercih edilen ürün seçeneği fiyatı etkileyebilir.",
              },
              {
                q: "Fiat fren balatası için bilgi alabilir miyim?",
                a: "Evet. Fiat aracınızın model ve araç bilgilerini paylaşarak fren balatası hakkında WhatsApp üzerinden bilgi isteyebilirsiniz.",
              },
              {
                q: "Fiat yedek parça ararken hangi bilgiler gerekir?",
                a: "Fiat modeliniz, model yılı, motor bilgisi ve aradığınız parçanın adı doğru parçanın araştırılmasına yardımcı olur.",
              },
            ].map((item) => (
              <details
                key={item.q}
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-5xl px-6 py-16 text-center lg:px-8 lg:py-24">
          ...
          <h2 className="mt-4 text-3xl font-black sm:text-5xl">
            Fiat yedek parçanızı arıyorsanız bize sorun.
          </h2>

          <p className="mx-auto mt-5 max-w-2xl leading-8 text-slate-400">
            Fiat modelinizi ve aradığınız parçayı WhatsApp üzerinden
