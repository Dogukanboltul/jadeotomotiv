...
const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%2C%20Beylikd%C3%BCz%C3%BC%20oto%20yedek%20par%C3%A7a%20sipari%C5%9Fi%20vermek%20istiyorum.%20Ara%C3%A7%20marka%2Fmodel%3A%20%20Y%C4%B1l%3A%20%20Arad%C4%B1%C4%9F%C4%B1m%20par%C3%A7a%3A";
...
export const metadata: Metadata = {
  title: "Beylikdüzü Oto Yedek Parça Siparişi | Jade Automotive",
  description:
    "Beylikdüzü oto yedek parça siparişi için araç marka, model, yıl ve parça bilgilerinizi gönderin. WhatsApp'tan parça sorun veya Jade Automotive online mağazalarını inceleyin.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/beylikduzu-oto-yedek-parca-siparisi",
  },
};
...
const categories = [
  {
    ...
    text: "Fren balatası, fren diski ve fren sistemi parçalarını araç bilgilerinizi paylaşarak sorgulayın.",
  },
  {
    icon: "⚙️",
    title: "Filtre & Bakım Parçaları",
    text: "Yağ, hava, polen ve yakıt filtresi gibi periyodik bakım parçaları için bilgi alın.",
  },
  {
    icon: "🔧",
    title: "Debriyaj Parçaları",
    text: "Debriyaj seti ve aktarma sistemi parçalarını marka, model ve yıl bilgisiyle sorun.",
  },
  {
    icon: "🚗",
    title: "Süspansiyon & Ön Takım",
    text: "Amortisör, salıncak, rot ve diğer ön takım parçaları için iletişime geçin.",
  },
  {
    icon: "🔩",
    title: "Motor Parçaları",
    text: "Motor parçaları için araç modeli, üretim yılı ve mümkünse motor bilgisini paylaşın.",
  },
  {
    icon: "⚡",
    title: "Elektrik Parçaları",
    text: "Elektrik, ateşleme ve yardımcı sistem parçalarını WhatsApp üzerinden sorgulayın.",
  },
];
  ...
  return (
    <main className="min-h-screen bg-[#06111f] text-white">
      ...
      <a
        ...
        aria-label="WhatsApp'tan oto yedek parça siparişi"
        ...
        <div className="jade-wrap py-20 md:py-28">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">
              Beylikdüzü ve çevresinde aracınız için yedek parça
              arıyorsanız marka, model, model yılı ve ihtiyaç duyduğunuz
              parçayı göndererek Jade Automotive ile iletişime geçin.
            </p>
      ...
      <section className="jade-wrap py-20">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-3xl font-black md:text-4xl">
            Oto yedek parça siparişi nasıl verilir?
          </h2>

          <p className="mx-auto mt-5 max-w-3xl leading-8 text-slate-400">
            Yanlış ürün seçme riskini azaltmak için araç ve parça
            bilgilerinin mümkün olduğunca açık paylaşılması önemlidir.
          </p>
        </div>

        <div className="mt-10 grid gap-5 md:grid-cols-4">
          {[
            ["01", "Marka & Model", "Aracınızın marka ve modelini gönderin."],
            ["02", "Model Yılı", "Aracınızın üretim yılını belirtin."],
            ["03", "Parça", "İhtiyaç duyduğunuz parçanın adını yazın."],
            ["04", "WhatsApp", "Bilgileri göndererek parça hakkında bilgi alın."],
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_.8fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-2xl leading-8 text-slate-400">
                Araçların model yılı, motor seçeneği ve versiyonuna göre
                kullanılan parçalar değişebilir. Bu nedenle doğru parçayı
                sorgularken araç bilgilerinizi de iletin.
              </p>
            </div>
      ...
      <section className="jade-wrap py-20">
        <div className="jade-card rounded-3xl p-8 md:p-12">
          ...
          <h2 className="mt-3 text-3xl font-black md:text-4xl">
            Beylikdüzü'nde Oto Yedek Parça Siparişi
          </h2>

          <p className="mt-5 max-w-4xl leading-8 text-slate-300">
            Araç bakım ve onarımında ihtiyaç duyulan yedek parçanın
            doğru seçilmesi önemlidir. Fren parçaları, filtreler,
            süspansiyon parçaları, motor parçaları, debriyaj ve elektrik
            parçaları gibi farklı ürün gruplarında araç uyumluluğu
            kontrol edilmelidir.
          </p>

          <p className="mt-5 max-w-4xl leading-8 text-slate-400">
            Daha fazla ürün grubu ve bilgi için Jade Automotive{" "}
            <Link
              href="/beylikduzu-oto-yedek-parca"
            ...
            sayfasını inceleyebilir, ihtiyaç duyduğunuz parçayı
            WhatsApp üzerinden sorgulayabilirsiniz.
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-white/5 bg-[#081727]">
        <div className="jade-wrap py-20">
          ...
          <h2 className="mt-3 text-3xl font-black md:text-4xl">
            Oto yedek parça sipariş seçenekleri
          </h2>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div className="jade-card rounded-2xl p-8">
            <h2 className="text-2xl font-black">
              Doğru oto yedek parça nasıl seçilir?
            </h2>

            <p className="mt-4 leading-8 text-slate-400">
              Aynı araç modelinde bile üretim yılı, motor tipi veya
              versiyona göre farklı parçalar kullanılabilir. Sipariş
              öncesinde araç bilgilerinin kontrol edilmesi yanlış parça
              seçme riskini azaltmaya yardımcı olur.
            </p>
          </div>

          <div className="jade-card rounded-2xl p-8">
            <h2 className="text-2xl font-black">
              Şase numarası neden önemlidir?
            </h2>

            <p className="mt-4 leading-8 text-slate-400">
              Bazı parçalarda marka, model ve yıl bilgisi tek başına
              yeterli olmayabilir. Gerektiğinde şase numarası ve motor
              bilgisi aracın doğru parçasının belirlenmesine yardımcı
              olabilir.
            </p>
          </div>
        </div>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-400">
                Trendyol'daki Jade Automotive ürünlerini inceleyerek
                online alışveriş seçeneklerine ulaşabilirsiniz.
              </p>
      ...
      <section className="jade-glow">
        <div className="jade-wrap py-20">
          <div className="jade-card rounded-3xl p-8 text-center md:p-12">
            ...
            <p className="mx-auto mt-5 max-w-3xl leading-8 text-slate-400">
              Beylikdüzü ve çevresinde oto yedek parça seçenekleri,
              ürün grupları ve araç uyumluluğu hakkında ana sayfamızı
              inceleyebilirsiniz.
            </p>
      ...
      <section className="border-t border-white/5 bg-[#081727]">
        <div className="jade-wrap py-20">
          ...
          <h2 className="mt-3 text-3xl font-black">
            Oto yedek parça siparişi hakkında
          </h2>

          <div className="mt-8 max-w-4xl space-y-4">
            <details className="jade-card rounded-2xl p-6">
              <summary className="cursor-pointer font-black">
                Beylikdüzü oto yedek parça siparişi nasıl verilir?
              </summary>

              <p className="mt-4 leading-7 text-slate-400">
                Araç marka, model, model yılı ve aradığınız parçayı
                WhatsApp üzerinden göndererek Jade Automotive ile
            ...
            <details className="jade-card rounded-2xl p-6">
              <summary className="cursor-pointer font-black">
                Aracıma uygun parçayı nasıl sorgularım?
              </summary>

              <p className="mt-4 leading-7 text-slate-400">
                Marka, model ve model yılıyla birlikte mümkünse motor
                bilgisi veya ihtiyaç halinde şase bilgisi paylaşılması
                doğru parçanın belirlenmesini kolaylaştırır.
              </p>
            </details>

            <details className="jade-card rounded-2xl p-6">
              <summary className="cursor-pointer font-black">
                Online oto yedek parça siparişi verebilir miyim?
              </summary>

              <p className="mt-4 leading-7 text-slate-400">
                Jade Automotive'in Trendyol ve Hepsiburada mağazalarındaki
                ürünleri inceleyerek online alışveriş yapabilirsiniz.
              </p>
            </details>

            <details className="jade-card rounded-2xl p-6">
              <summary className="cursor-pointer font-black">
                Oto yedek parça fiyatını nasıl öğrenebilirim?
              </summary>

              <p className="mt-4 leading-7 text-slate-400">
                Aracınızın marka, model ve yıl bilgisini, aradığınız
                parçayla birlikte WhatsApp üzerinden göndererek fiyat
                bilgisi isteyebilirsiniz.
              </p>
            </details>
          </div>
        </div>
        ...
        <div className="jade-wrap py-20 text-center md:py-28">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-400">
              ...
              veya Jade Automotive online mağazalarını incele.
            </p>
