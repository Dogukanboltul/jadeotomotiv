...
export const metadata: Metadata = {
  title: "Beylikdüzü Toyota Yedek Parça | Jade Automotive",
  description:
    "Beylikdüzü Toyota yedek parça arayanlar için fren balatası, filtre, debriyaj, süspansiyon, motor ve elektrik parçaları. Toyota aracınıza uygun yedek parça ve fiyat bilgisi için WhatsApp'tan ulaşın.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/beylikduzu-toyota-yedek-parca",
  },
  robots: {
    index: true,
    follow: true,
...
const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%2C%20Toyota%20yedek%20par%C3%A7a%20ar%C4%B1yorum.%20Model%3A%20%20Y%C4%B1l%3A%20%20Arad%C4%B1%C4%9F%C4%B1m%20par%C3%A7a%3A";

const parts = [
  {
    title: "Fren Balatası",
    text: "Toyota aracınız için fren balatası ve fren sistemi parçaları hakkında bilgi alın.",
  },
  {
    title: "Filtreler",
  ...
  {
    title: "Süspansiyon",
    text: "Amortisör, salıncak ve yürüyen aksam parçaları için bilgi alın.",
  },
  {
    title: "Motor Parçaları",
    text: "Bakım ve onarım ihtiyaçlarınız için Toyota motor parçalarını araştırın.",
  },
  {
  ...
  return (
    <main className="min-h-screen bg-[#06111f] text-white pb-20 lg:pb-0">
      ...
      <a
        ...
        aria-label="WhatsApp üzerinden Toyota yedek parça sor"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/10 bg-[#050d18]/95 p-3 backdrop-blur lg:hidden">
        ...
        >
          Toyota Parçamı WhatsApp'tan Sor
        </a>
      </div>
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-16 lg:px-8 lg:pb-28 lg:pt-24">
          ...
          <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300 sm:text-xl">
            Toyota aracınız için yedek parça mı arıyorsunuz? Model, yıl ve
      ...
      <section className="border-b border-white/10 bg-[#081827]">
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-8">
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ["1. Modelini Yaz", "Toyota modelinizi ve model yılınızı gönderin."],
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div>
            <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400">
              Toyota Parça Arayanlara
            </p>

            <h2 className="text-3xl font-black sm:text-4xl">
              Toyota aracınız için doğru yedek parçayı bulun
            </h2>

            <div className="mt-7 space-y-5 text-base leading-8 text-slate-300">
              <p>
                Toyota yedek parça ararken aracın modeli, model yılı ve motor
                seçeneği gibi bilgiler doğru parçanın araştırılmasına yardımcı
                olabilir.
              </p>

              <p>
                Beylikdüzü ve çevresinde Toyota yedek parça arıyorsanız
            ...
            >
              💬 Toyota Yedek Parça Fiyatını Sor
            </a>
          </div>
      ...
      <section className="border-y border-white/10 bg-[#081827]">
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          ...
          <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400">
            Toyota Yedek Parça Grupları
          </p>

          <h2 className="text-3xl font-black sm:text-4xl">
            Hangi Toyota parçasını arıyorsunuz?
          </h2>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black sm:text-4xl">
                Toyota fren balatası mı arıyorsunuz?
              </h2>

              <p className="mt-5 max-w-3xl leading-8 text-slate-300">
                Fren sistemi parçalarında aracınıza uygun ürünün belirlenmesi
                önemlidir. Toyota modelinizi ve araç bilgilerinizi göndererek
                bilgi alabilirsiniz.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black sm:text-4xl">
                Toyota yedek parça fiyatını öğrenin
              </h2>
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-8">
              ...
              <p className="mt-3 leading-7 text-slate-400">
                Toyota modelinizi, yılınızı ve mümkünse motor seçeneğinizi
                paylaşın.
              </p>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8">
            ...
            <div className="mt-7 space-y-3">
              ...
              <Link
                href="/blog/beylikduzu-citroen-yedek-parca"
                className="block rounded-xl border border-white/10 bg-slate-950/40 p-4 font-semibold"
              >
          ...
          <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.06] p-8">
            ...
            <h2 className="mt-3 text-3xl font-black">
              Toyota parçanızı hemen sorun
            </h2>

            <p className="mt-5 leading-8 text-slate-300">
              Toyota modelinizi, yılınızı ve aradığınız parçayı gönderin.
            ...
            >
              💬 WhatsApp'tan Toyota Parçası Sor
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-white/10 bg-[#040c16]">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-8 lg:py-24">
          ...
          <div className="mt-10 space-y-4">
            ...
            {[
              [
                "Beylikdüzü'nde Toyota yedek parça nereden alınır?",
                "Beylikdüzü ve çevresinde Toyota yedek parça arıyorsanız Jade Automotive ile iletişime geçerek aracınıza uygun parça hakkında bilgi alabilirsiniz.",
              ],
              [
                "Toyota yedek parça fiyatını nasıl öğrenebilirim?",
                "Toyota modelinizi, model yılınızı ve aradığınız parçayı WhatsApp üzerinden göndererek aracınıza özel fiyat bilgisi isteyebilirsiniz.",
              ],
              [
                "Toyota fren balatası için bilgi alabilir miyim?",
                "Evet. Toyota modelinizi ve araç bilgilerinizi paylaşarak fren balatası hakkında WhatsApp üzerinden bilgi isteyebilirsiniz.",
              ],
              [
                "Toyota yedek parça ararken hangi bilgiler gerekir?",
      ...
      <section className="border-t border-white/10">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16 text-center lg:px-8 lg:py-24">
          ...
          <h2 className="mt-6 text-3xl font-black sm:text-5xl">
            Toyota yedek parçanızı mı arıyorsunuz?
          </h2>
