...
export const metadata: Metadata = {
  title: "Esenyurt Fatih Oto Sanayi Yedek Parça | Jade Automotive",
  description:
    "Esenyurt Fatih Oto Sanayi çevresinde oto yedek parça arayanlar için fren, ön takım, filtre, süspansiyon, debriyaj ve motor parçaları. WhatsApp'tan parça sorun.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/esenyurt-fatih-oto-sanayi-yedek-parca",
  },
};

const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%20Jade%20Automotive%20%F0%9F%91%8B%0AEsenyurt%20Fatih%20Oto%20Sanayi%20%C3%A7evresinden%20yedek%20par%C3%A7a%20ar%C4%B1yorum.%0A%0AMarka%20%2F%20Model%3A%20%0AY%C4%B1l%3A%20%0AMotor%3A%20%0AArad%C4%B1%C4%9F%C4%B1m%20Par%C3%A7a%3A%20";
...
const categories = [
  ["🛑", "Fren Parçaları", "Fren balatası, fren diski ve ilgili fren sistemi parçaları."],
  ["🔧", "Ön Takım Parçaları", "Rot başı, rotil, salıncak, Z rot ve bağlantı parçaları."],
  ["〰️", "Süspansiyon Parçaları", "Amortisör, takoz, rulman ve süspansiyon bağlantı parçaları."],
  ...
  ["🧰", "Debriyaj & Aktarma", "Debriyaj seti ve aktarma sistemiyle ilgili yedek parçalar."],
];

const faq = [
  {
    q: "Esenyurt Fatih Oto Sanayi çevresinde yedek parça arıyorum, nasıl sorabilirim?",
  ...
  },
  {
    ...
    a: "Parça kodunu bilmeniz şart değildir. Araç bilgilerinizi ve aradığınız parçayı yazabilirsiniz. Elinizde eski parçanın veya kutusunun fotoğrafı varsa onu da gönderebilirsiniz.",
  },
  {
  ...
  {
    q: "Oto yedek parça fiyatını nasıl öğrenebilirim?",
    a: "Araç bilgileriyle birlikte aradığınız parçayı WhatsApp üzerinden göndererek uygun ürün ve güncel fiyat seçeneklerini sorabilirsiniz.",
  },
];
...
export default function Page() {
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Esenyurt Fatih Oto Sanayi Yedek Parça",
    description:
      "Esenyurt Fatih Oto Sanayi çevresinde oto yedek parça arayanlar için parça rehberi.",
    mainEntityOfPage:
      "https://www.frenbalataci.com.tr/blog/esenyurt-fatih-oto-sanayi-yedek-parca",
    author: {
      "@type": "Organization",
      ...
      <main className="min-h-screen bg-[#07111d] text-white">
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative mx-auto max-w-6xl px-5 py-16 md:py-24">
            ...
            <span className="inline-flex rounded-full border border-[#25D366]/30 bg-[#25D366]/10 px-4 py-2 text-sm font-black text-[#62e893]">
              🔧 Aradığın parçayı WhatsApp'tan sor
            </span>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Esenyurt Fatih Oto Sanayi çevresinde{" "}
              <strong className="text-white">oto yedek parça</strong>{" "}
              arıyorsan araç bilgilerini gönder. Fren, ön takım, filtre,
              süspansiyon, debriyaj ve motor parçaları için bize
              WhatsApp'tan ulaşabilirsin.
            </p>

            <div className="mt-8 max-w-2xl rounded-3xl border border-[#25D366]/30 bg-[#25D366]/10 p-6">
              <h2 className="text-2xl font-black">
                “Usta parçayı söyledi, nereden bulacağım?”
              </h2>

              <p className="mt-3 leading-7 text-slate-300">
                Marka + model + yıl + motor + parça adını gönder. Parça kodun
                veya fotoğrafın varsa onu da ekle 👋
              </p>
              ...
              >
                💬 Fatih Oto Sanayi Yedek Parça Sor
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-5 py-14">
          <div className="grid gap-4 md:grid-cols-4">
            {[
              ["🚗", "Marka / Model", "Aracını yaz"],
              ["📅", "Üretim Yılı", "Yıl bilgisini yaz"],
        ...
        <section className="mx-auto max-w-6xl px-5 py-16">
          <div className="grid gap-5 md:grid-cols-2">
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
              <span className="font-black text-cyan-300">
                USTAN PARÇA MI İSTEDİ?
              </span>
              <h2 className="mt-3 text-2xl font-black">
                Parça adını bize gönder
              </h2>
              <p className="mt-4 leading-8 text-slate-300">
                Fren balatası, disk, salıncak, rot başı, amortisör, filtre,
                debriyaj seti veya başka bir yedek parça gerekiyorsa araç
                bilgileriyle birlikte bize yaz.
              </p>
            </article>
            ...
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
              ...
              <h2 className="mt-3 text-2xl font-black">
                Fotoğrafını gönderebilirsin
              </h2>
              <p className="mt-4 leading-8 text-slate-300">
                Elinde eski parça, kutu veya referans numarası varsa
                fotoğrafını WhatsApp üzerinden gönderebilirsin.
              </p>
            </article>
          </div>
        </section>
            ...
            <div className="grid items-center gap-8 md:grid-cols-[1fr_auto]">
              <div>
                ...
                <h2 className="mt-2 max-w-3xl text-3xl font-black md:text-4xl">
                  Fatih Oto Sanayi'de parçanı aramakla uğraşma, bize sor.
                </h2>

                <p className="mt-4 max-w-2xl font-medium leading-7">
                  Marka + model + yıl + motor + parça adını WhatsApp'tan
                  gönder.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-6xl px-5 pb-16">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Clio fren, ön takım, motor ve bakım parçaları.
              </p>
            </Link>
            ...
            >
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Megane için yedek parça seçenekleri.
              </p>
            </Link>
          </div>
        </section>
        ...
        <section className="border-y border-white/10 bg-[#0a1928]">
          <div className="mx-auto max-w-6xl px-5 py-14">
            ...
            <p className="mt-3 text-slate-400">
              Aradığın parçayı mağazalarda göremediysen WhatsApp'tan
        ...
        <section className="px-5 pb-24">
          <div className="mx-auto max-w-6xl rounded-[36px] border border-[#25D366]/20 bg-gradient-to-br from-[#25D366]/10 to-cyan-400/10 p-8 text-center md:p-14">
            ...
            <h2 className="mx-auto mt-5 max-w-4xl text-3xl font-black md:text-5xl">
              Esenyurt Fatih Oto Sanayi çevresinde yedek parça mı arıyorsun?
            </h2>
