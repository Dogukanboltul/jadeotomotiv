...
export const metadata: Metadata = {
  title: "Beylikdüzü Citroën Yedek Parça | Jade Automotive",
  description:
    "Beylikdüzü Citroën yedek parça arayanlar için fren balatası, filtre, debriyaj, süspansiyon, motor ve elektrik parçaları. Citroën aracınıza uygun yedek parça ve fiyat bilgisi için WhatsApp'tan ulaşın.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/beylikduzu-citroen-yedek-parca",
  },
};

const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%2C%20Citro%C3%ABn%20yedek%20par%C3%A7a%20ar%C4%B1yorum.%20Model%3A%20%20Y%C4%B1l%3A%20%20Arad%C4%B1%C4%9F%C4%B1m%20par%C3%A7a%3A";

const parts = [
  ["Fren Balatası", "Citroën aracınız için fren balatası ve fren sistemi parçaları hakkında bilgi alın."],
  ["Filtreler", "Yağ, hava, polen ve yakıt filtreleri gibi bakım parçalarını araştırın."],
  ["Debriyaj", "Debriyaj sistemi ve ilgili parçalar için aracınıza uygun seçenekleri sorun."],
  ["Süspansiyon", "Amortisör, salıncak ve yürüyen aksam parçaları için bilgi alın."],
  ["Motor Parçaları", "Bakım ve onarım ihtiyaçlarınız için Citroën motor parçalarını araştırın."],
  ["Elektrik & Ateşleme", "Elektrik ve ateşleme sistemi parçaları hakkında aracınıza özel bilgi alın."],
];
  ...
  return (
    <main className="min-h-screen bg-[#06111f] text-white pb-20 lg:pb-0">
      ...
      <a
        ...
        aria-label="WhatsApp üzerinden Citroën yedek parça sor"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/10 bg-[#050d18]/95 p-3 backdrop-blur lg:hidden">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center rounded-xl bg-[#25D366] px-5 py-3.5 font-black text-slate-950"
        >
          Citroën Parçamı WhatsApp'tan Sor
        </a>
      </div>
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-16 lg:px-8 lg:pb-28 lg:pt-24">
          ...
          <h1 className="max-w-5xl text-4xl font-black leading-tight tracking-tight sm:text-5xl lg:text-7xl">
            Beylikdüzü Citroën Yedek Parça
          </h1>

          <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300 sm:text-xl">
            Citroën aracınız için yedek parça mı arıyorsunuz? Model, yıl ve
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-xl border border-white/15 bg-white/5 px-7 py-4 font-bold"
            >
              Tüm Yedek Parçalar
            </Link>
          </div>
          ...
          <p className="mt-4 text-sm text-slate-500">
            Model + yıl + parça adını göndermen yeterli.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-white/10 bg-[#081827]">
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-8">
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ["1. Modelini Yaz", "Citroën modelinizi ve model yılınızı gönderin."],
              ["2. Parçayı Yaz", "Aradığınız yedek parçanın adını belirtin."],
              ["3. WhatsApp'tan Sor", "Parça ve fiyat hakkında bilgi alın."],
            ].map(([title, text]) => (
              <div key={title} className="rounded-2xl border border-white/10 bg-white/[0.035] p-6">
                <h2 className="text-lg font-black text-cyan-300">{title}</h2>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400">
              Citroën Parça Arayanlara
            </p>

            <h2 className="text-3xl font-black sm:text-4xl">
              Citroën aracınız için doğru yedek parçayı bulun
            </h2>

            <div className="mt-7 space-y-5 text-base leading-8 text-slate-300">
              <p>
                Citroën yedek parça ararken aracın modeli, model yılı ve motor
                seçeneği gibi bilgiler doğru parçanın araştırılmasına yardımcı
                olabilir.
              </p>

              <p>
                Beylikdüzü ve çevresinde Citroën yedek parça arıyorsanız
                aracınızın bilgilerini paylaşarak ihtiyacınız olan parçayı
                daha kolay araştırabilirsiniz.
              </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 inline-flex rounded-xl bg-cyan-400 px-7 py-4 font-black text-slate-950"
            >
              💬 Citroën Yedek Parça Fiyatını Sor
            </a>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-7">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 flex items-center justify-center rounded-xl bg-[#25D366] px-6 py-4 font-black text-white"
            >
      ...
      <section className="border-y border-white/10 bg-[#081827]">
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400">
            Citroën Yedek Parça Grupları
          </p>

          <h2 className="text-3xl font-black sm:text-4xl">
            Hangi Citroën parçasını arıyorsunuz?
          </h2>

          <p className="mt-5 max-w-3xl leading-8 text-slate-300">
            Bakım ve onarım ihtiyacınıza göre aşağıdaki parça gruplarından
            ihtiyacınız olan ürünü araştırabilirsiniz.
          </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black sm:text-4xl">
                Citroën fren balatası mı arıyorsunuz?
              </h2>

              <p className="mt-5 max-w-3xl leading-8 text-slate-300">
                Fren sistemi parçalarında aracınıza uygun ürünün belirlenmesi
                önemlidir. Citroën modelinizi ve araç bilgilerinizi göndererek
                bilgi alabilirsiniz.
              </p>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex justify-center rounded-xl bg-[#25D366] px-7 py-4 font-black text-white"
            >
              Fren Balatası Sor
            </a>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black sm:text-4xl">
                Citroën yedek parça fiyatını öğrenin
              </h2>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-7 inline-flex rounded-xl bg-cyan-400 px-7 py-4 font-black text-slate-950"
              >
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-8">
              ...
              <h3 className="mt-5 text-2xl font-bold">Aracınızı belirtin</h3>
              <p className="mt-3 leading-7 text-slate-400">
                Citroën modelinizi, yılınızı ve mümkünse motor seçeneğinizi
                paylaşın.
              </p>
              ...
              <h3 className="mt-5 text-2xl font-bold">Parçanızı belirtin</h3>
              <p className="mt-3 leading-7 text-slate-400">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8">
            ...
            <div className="mt-7 space-y-3">
              <Link
                href="/beylikduzu-oto-yedek-parca"
                className="block rounded-xl border border-white/10 bg-slate-950/40 p-4 font-semibold"
              >
              ...
              <Link
                href="/blog/beylikduzu-peugeot-yedek-parca"
                className="block rounded-xl border border-white/10 bg-slate-950/40 p-4 font-semibold"
              >
          ...
          <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.06] p-8">
            ...
            <h2 className="mt-3 text-3xl font-black">
              Citroën parçanızı hemen sorun
            </h2>

            <p className="mt-5 leading-8 text-slate-300">
              Citroën modelinizi, yılınızı ve aradığınız parçayı gönderin.
              Parça ve fiyat hakkında bilgi almak için doğrudan WhatsApp'a geçin.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-7 flex items-center justify-center rounded-xl bg-[#25D366] px-6 py-4 font-black text-white"
            >
              💬 WhatsApp'tan Citroën Parçası Sor
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-white/10 bg-[#040c16]">
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-8 lg:py-24">
          ...
          <div className="mt-10 space-y-4">
            {[
              [
                "Beylikdüzü'nde Citroën yedek parça nereden alınır?",
                "Beylikdüzü ve çevresinde Citroën yedek parça arıyorsanız Jade Automotive ile iletişime geçerek aracınıza uygun parça hakkında bilgi alabilirsiniz.",
              ],
              [
                "Citroën yedek parça fiyatını nasıl öğrenebilirim?",
                "Citroën modelinizi, model yılınızı ve aradığınız parçayı WhatsApp üzerinden göndererek aracınıza özel fiyat bilgisi isteyebilirsiniz.",
              ],
              [
                "Citroën fren balatası için bilgi alabilir miyim?",
                "Evet. Citroën modelinizi ve araç bilgilerinizi paylaşarak fren balatası hakkında WhatsApp üzerinden bilgi isteyebilirsiniz.",
              ],
              [
                "Citroën yedek parça ararken hangi bilgiler gerekir?",
                "Araç modeli, model yılı, motor seçeneği ve aradığınız parçanın adı doğru parçanın araştırılmasına yardımcı olur.",
              ],
            ].map(([q, a]) => (
              <details
                key={q}
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-5xl px-6 py-16 text-center lg:px-8 lg:py-24">
          ...
          <h2 className="mt-6 text-3xl font-black sm:text-5xl">
            Citroën yedek parçanızı mı arıyorsunuz?
          </h2>

          <p className="mx-auto mt-5 max-w-2xl leading-8 text-slate-400">
            Modelinizi, yılınızı ve aradığınız parçayı gönderin. Parça ve fiyat
            hakkında bilgi almak için WhatsApp'tan bize ulaşın.
          </p>
