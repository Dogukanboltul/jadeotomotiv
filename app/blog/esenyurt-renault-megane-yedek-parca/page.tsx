...
export const metadata: Metadata = {
  title: "Esenyurt Renault Megane Yedek Parça | Jade Automotive",
  description:
    "Esenyurt Renault Megane yedek parça arayanlar için fren, ön takım, filtre, süspansiyon, debriyaj, triger ve motor parçaları. Parçanızı WhatsApp'tan sorun.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/esenyurt-renault-megane-yedek-parca",
  },
};

const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%20Jade%20Automotive%20%F0%9F%91%8B%0ARenault%20Megane%20i%C3%A7in%20yedek%20par%C3%A7a%20ar%C4%B1yorum.%0A%0AY%C4%B1l%3A%20%0AMotor%3A%20%0AArad%C4%B1%C4%9F%C4%B1m%20Par%C3%A7a%3A%20%0AVarsa%20Par%C3%A7a%20Kodu%3A%20";
...
const parts = [
  {
    icon: "🛑",
    title: "Megane Fren Parçaları",
    text: "Fren balatası, fren diski ve ilgili fren sistemi parçaları.",
  },
  {
    icon: "🔧",
    title: "Megane Ön Takım Parçaları",
    text: "Rot başı, rotil, salıncak, Z rot ve bağlantı parçaları.",
  },
  {
    icon: "〰️",
    title: "Megane Süspansiyon Parçaları",
    text: "Amortisör, amortisör takozu ve süspansiyon bağlantı parçaları.",
  },
  {
    icon: "⚙️",
    title: "Megane Triger Parçaları",
    text: "Motor seçeneğine göre triger sistemi, gergi ve ilgili parçalar.",
  },
  {
    icon: "🧰",
    title: "Megane Debriyaj Parçaları",
    text: "Debriyaj seti, baskı, balata ve ilgili aktarma parçaları.",
  },
  {
    icon: "🌬️",
    title: "Megane Filtre Seti",
    text: "Hava, yağ, polen ve yakıt filtresi seçenekleri.",
  },
];

const searches = [
  "Renault Megane Fren Balatası",
  "Renault Megane Fren Diski",
  "Renault Megane Salıncak",
  "Renault Megane Rot Başı",
  "Renault Megane Rotil",
  "Renault Megane Z Rot",
  "Renault Megane Amortisör",
  "Renault Megane Debriyaj Seti",
  "Renault Megane Triger Seti",
  "Renault Megane Devirdaim Pompası",
  "Renault Megane Filtre Seti",
  "Renault Megane Motor Parçaları",
];

const faq = [
  {
    q: "Esenyurt Renault Megane yedek parça nasıl bulabilirim?",
    a: "Renault Megane'ın üretim yılı, motor bilgisi ve aradığınız parçayı WhatsApp üzerinden gönderebilirsiniz. Araç versiyonuna uygun parçanın kontrol edilmesi önemlidir.",
  },
  {
    q: "Renault Megane yedek parçaları bütün modellerde aynı mı?",
    a: "Hayır. Megane'ın nesli, üretim yılı, motoru ve versiyonuna göre kullanılan parçalar değişebilir.",
  },
  {
    q: "Renault Megane için hangi parçaları sorabilirim?",
    a: "Fren, ön takım, süspansiyon, filtre, debriyaj, triger, devirdaim ve çeşitli motor parçaları için araç bilgilerinizi gönderebilirsiniz.",
  },
  {
    q: "Megane parça kodunu bilmiyorum, yine de sorabilir miyim?",
    a: "Evet. Araç yılı, motor ve aradığınız parçayı gönderebilirsiniz. Elinizde eski parçanın veya kutusunun fotoğrafı varsa onu da paylaşabilirsiniz.",
  },
  {
    q: "Renault Megane yedek parça fiyatını nasıl öğrenebilirim?",
    a: "Aradığınız parça ile aracın yıl ve motor bilgisini WhatsApp üzerinden göndererek mevcut ürün ve fiyat seçeneklerini sorabilirsiniz.",
  },
];
...
export default function Page() {
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Esenyurt Renault Megane Yedek Parça",
    description:
      "Renault Megane fren, ön takım, filtre, süspansiyon, debriyaj, triger ve motor yedek parçaları rehberi.",
    mainEntityOfPage:
      "https://www.frenbalataci.com.tr/blog/esenyurt-renault-megane-yedek-parca",
    author: {
      "@type": "Organization",
    ...
    <>
      ...
      <main className="min-h-screen bg-[#07111d] text-white">
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative mx-auto max-w-6xl px-5 py-16 md:py-24">
            ...
            <div className="mt-8 max-w-2xl rounded-3xl border border-[#25D366]/30 bg-[#25D366]/10 p-6">
              ...
              >
                💬 Renault Megane Yedek Parça Sor
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="border-y border-white/10 bg-[#0a1928]">
          <div className="mx-auto max-w-6xl px-5 py-16">
            <span className="font-black text-cyan-300">
              RENAULT MEGANE YEDEK PARÇALARI
            </span>

            <h2 className="mt-3 text-3xl font-black md:text-4xl">
              Megane için hangi parçayı arıyorsun?
            </h2>
        ...
        <section className="mx-auto max-w-6xl px-5 py-16">
          <span className="font-black text-cyan-300">
            MEGANE PARÇA ÇEŞİTLERİ
          </span>

          <h2 className="mt-3 text-3xl font-black md:text-4xl">
            Renault Megane için aradığın parçayı bize yaz
          </h2>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              <article>
                ...
                <h2 className="mt-3 text-3xl font-black">
                  Her Renault Megane'a aynı parça olmaz
                </h2>

                <p className="mt-5 leading-8 text-slate-300">
                  Renault Megane farklı nesil, üretim yılı, motor ve araç
                  versiyonlarıyla üretildiği için aynı isimdeki yedek parçanın
                  farklı seçenekleri bulunabilir.
                </p>

                <p className="mt-4 leading-8 text-slate-400">
                  Bu nedenle parçayı seçerken araç yılı, motor bilgisi ve
                  ihtiyaç duyulan parçanın birlikte kontrol edilmesi önemlidir.
                </p>
              </article>
            ...
            <div className="grid items-center gap-8 md:grid-cols-[1fr_auto]">
              <div>
                ...
                <h2 className="mt-2 max-w-3xl text-3xl font-black md:text-4xl">
                  Megane parçanı internette tek tek aramakla uğraşma.
                </h2>

                <p className="mt-4 max-w-2xl font-medium leading-7">
                  Yıl + motor + aradığın parçayı gönder. Ustan parça kodu
                  verdiyse onu da mesaja ekle.
                </p>
              </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Esenyurt ve çevresinde oto yedek parça.
              </p>
            </Link>
            ...
            >
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Renault Clio yedek parça rehberi.
              </p>
            </Link>
            ...
            >
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Renault araçlar için yedek parça seçenekleri.
              </p>
            </Link>
          </div>
        </section>
        ...
        <section className="border-y border-white/10 bg-[#0a1928]">
          <div className="mx-auto max-w-6xl px-5 py-14">
            ...
            <p className="mt-3 text-slate-400">
              Megane parçanı mağazalarda göremediysen WhatsApp'tan doğrudan
              sorabilirsin.
            </p>
        ...
        <section className="px-5 pb-24">
          <div className="mx-auto max-w-6xl rounded-[36px] border border-[#25D366]/20 bg-gradient-to-br from-[#25D366]/10 to-cyan-400/10 p-8 text-center md:p-14">
            ...
            <h2 className="mx-auto mt-5 max-w-4xl text-3xl font-black md:text-5xl">
              Renault Megane için hangi parçayı arıyorsun?
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">
              Yıl + motor + parça adını gönder. Parça kodun veya fotoğrafın
              varsa onu da ekle.
            </p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Renault Megane yedek parça sor"
