...
export const metadata: Metadata = {
  title: "Esenyurt Acil Oto Yedek Parça | Fiyat ve Stok Sor",
  description:
    "Esenyurt acil oto yedek parça arıyorsanız araç bilgilerinizi veya ustanızın istediği parçayı gönderin. Fiyat ve stok bilgisini WhatsApp'tan sorun.",
  alternates: {
    canonical:
      "https://www.frenbalataci.com.tr/blog/esenyurt-acil-oto-yedek-parca",
  },
};

const whatsapp =
  "https://wa.me/905435571529?text=Merhaba%20Jade%20Automotive%20%F0%9F%91%8B%0AEsenyurt%27ta%20acil%20oto%20yedek%20par%C3%A7a%20ar%C4%B1yorum.%0A%0AMarka%20%2F%20Model%3A%20%0AY%C4%B1l%3A%20%0AMotor%3A%20%0AArad%C4%B1%C4%9F%C4%B1m%20Par%C3%A7a%3A%20%0A%0AFiyat%20ve%20stok%20bilgisi%20alabilir%20miyim%3F";

const parts = [
  ["🛑", "Fren Balatası", "Ön veya arka fren balatası"],
  ["⭕", "Fren Diski", "Ön ve arka fren diskleri"],
  ["🔧", "Ön Takım", "Salıncak, rot, rotil, Z rot"],
  ["〰️", "Amortisör", "Amortisör ve bağlantı parçaları"],
  ["🌬️", "Filtre Seti", "Yağ, hava, polen ve yakıt filtreleri"],
  ["🧰", "Debriyaj Seti", "Baskı, balata ve ilgili parçalar"],
...
const faq = [
  {
    q: "Esenyurt'ta acil oto yedek parça arıyorum, nasıl sorabilirim?",
    a: "Araç marka, model, yıl, motor ve aradığınız parçayı WhatsApp üzerinden göndererek fiyat ve stok bilgisi sorabilirsiniz.",
  },
  {
  ...
  },
  {
    ...
    a: "Araç bilgilerinizi yazıp eski parçanın, kutunun veya üzerindeki parça numarasının fotoğrafını gönderebilirsiniz.",
  },
  {
    q: "Orijinal ve muadil seçenekleri sorabilir miyim?",
    a: "Aradığınız ürün için mevcut orijinal veya muadil seçenekleri ve fiyat bilgisini sorabilirsiniz.",
  },
];
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Esenyurt Acil Oto Yedek Parça",
        item:
          "https://www.frenbalataci.com.tr/blog/esenyurt-acil-oto-yedek-parca",
      },
    ],
  ...
  return (
    <>
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative mx-auto max-w-6xl px-5 py-14 md:py-24">
            ...
            <div className="mb-6 flex flex-wrap gap-2 text-sm text-slate-400">
              ...
              <span>›</span>
              <span>Acil Oto Yedek Parça</span>
            </div>

            <span className="inline-flex rounded-full border border-[#25D366]/30 bg-[#25D366]/10 px-4 py-2 text-sm font-black text-[#64e995]">
              🔧 Parçayı Gönder • Fiyat ve Stok Sor
            </span>

            <h1 className="mt-6 max-w-5xl text-4xl font-black leading-tight md:text-6xl">
              Esenyurt{" "}
              <span className="text-cyan-300">
                Acil Oto Yedek Parça
              </span>
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Araç ustada ve parça mı bekliyor? Aradığınız parçayı tek tek
              aramak yerine{" "}
              <strong className="text-white">
                araç bilgilerinizi ve parçayı WhatsApp'tan gönderin.
              </strong>{" "}
              Fiyat ve stok durumunu sorun.
            </p>

            {/* HOT LEAD BOX */}
            <div className="mt-8 max-w-2xl rounded-[28px] border border-[#25D366]/40 bg-[#25D366]/10 p-6 shadow-2xl">

              <p className="text-sm font-black uppercase tracking-wider text-[#64e995]">
                Aracın Ustada mı?
              </p>
              ...
              <p className="mt-3 leading-7 text-slate-300">
                Parça kodunu bilmene gerek yok. Ustanın verdiği listeyi,
                parça adını veya fotoğrafını gönderebilirsin.
              </p>
              ...
              >
                💬 PARÇAYI GÖNDER – FİYAT SOR
              </a>

              <p className="mt-3 text-center text-xs text-slate-400">
                Fotoğraf veya parça listesi de gönderebilirsiniz.
              </p>
            </div>
        ...
        <section className="mx-auto max-w-6xl px-5 py-12">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 transition hover:border-[#25D366]/40"
            >
              <div className="text-4xl">🔧</div>
              <h2 className="mt-4 text-xl font-black">
                Parça Adını Biliyorum
              </h2>
              <p className="mt-2 leading-6 text-slate-400">
                Aradığınız parçayı ve araç bilgilerini gönderin.
              </p>
              <span className="mt-4 inline-block font-black text-[#64e995]">
                Fiyat sor →
              </span>
            </a>
            ...
            >
              ...
              <p className="mt-2 leading-6 text-slate-400">
                Eski parçanın veya kutusunun fotoğrafını gönderin.
              </p>
              <span className="mt-4 inline-block font-black text-[#64e995]">
                Fotoğraf gönder →
              </span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-3xl border border-[#25D366]/30 bg-[#25D366]/5 p-6 transition hover:border-[#25D366]/60"
            >
              <div className="text-4xl">📋</div>
              <h2 className="mt-4 text-xl font-black">
                Ustan Liste Verdi
              ...
              <p className="mt-2 leading-6 text-slate-400">
                Parça listesinin fotoğrafını direkt WhatsApp'tan gönderin.
              </p>
              <span className="mt-4 inline-block font-black text-[#64e995]">
                Listeyi gönder →
              </span>
            ...
            <div className="mt-9 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
              {parts.map(([icon, title, text]) => (
                ...
                >
                  ...
                  <span className="mt-5 inline-block font-black text-[#64e995]">
                    Fiyat / stok sor →
                  </span>
                </a>
              ))}
        ...
        <section className="mx-auto max-w-6xl px-5 py-16">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <article className="rounded-[32px] border border-white/10 bg-white/[0.03] p-8">
              ...
              <span className="font-black text-cyan-300">
                ARAÇ USTADA BEKLİYORSA
              </span>

              <h2 className="mt-3 text-3xl font-black">
                Ustanın söylediği parçayı yazın
              </h2>

              <p className="mt-5 leading-8 text-slate-300">
                “Balata lazım”, “salıncak değişecek”, “triger seti lazım”
                veya “debriyaj seti gerekiyor” gibi ustanızın söylediği
                parçayı araç bilgilerinizle birlikte gönderebilirsiniz.
              </p>
              ...
              >
                Ustanın İstediği Parçayı Gönder →
              </a>

            </article>

            <article className="rounded-[32px] border border-[#25D366]/25 bg-[#25D366]/5 p-8">

              <span className="font-black text-[#64e995]">
                KODU BİLMİYORSAN
              </span>

              <h2 className="mt-3 text-3xl font-black">
                Fotoğrafını çek, WhatsApp'tan gönder
              </h2>

              <p className="mt-5 leading-8 text-slate-300">
                Eski parçanın, ürün kutusunun veya üzerindeki referans
                numarasının fotoğrafı varsa mesajınıza ekleyebilirsiniz.
              </p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 inline-block rounded-2xl border border-[#25D366]/40 px-6 py-4 font-black text-[#64e995]"
              >
                📸 Fotoğraf Gönder →
              </a>
        ...
        <section className="border-y border-white/10 bg-[#0a1928]">
          <div className="mx-auto max-w-6xl px-5 py-16">
            ...
            <h2 className="mt-3 max-w-4xl text-3xl font-black">
              Esenyurt'ta oto yedek parça arıyorsanız
            </h2>

            <p className="mt-5 max-w-4xl leading-8 text-slate-300">
              Fren, ön takım, süspansiyon, filtre, debriyaj ve motor
              parçaları için araç bilgilerinizi göndererek mevcut seçenekler
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="rounded-2xl bg-cyan-300 px-6 py-4 font-black text-[#07111d]"
              >
                Esenyurt Oto Yedek Parçacı →
              </Link>
            ...
            <div className="grid items-center gap-8 md:grid-cols-[1fr_auto]">
              ...
              <div>
                ...
                <h2 className="mt-2 max-w-3xl text-3xl font-black md:text-4xl">
                  Araç ustada parça mı bekliyor?
                </h2>

                <p className="mt-4 max-w-2xl font-medium leading-7">
                  Ustanın istediği parçayı veya listeyi WhatsApp'tan gönder.
        ...
        <section className="px-5 pb-24">
          <div className="mx-auto max-w-6xl rounded-[36px] border border-[#25D366]/30 bg-gradient-to-br from-[#25D366]/10 to-cyan-400/10 p-8 text-center md:p-14">
            ...
            <h2 className="mx-auto mt-5 max-w-4xl text-3xl font-black md:text-5xl">
              Parçayı aramakla vakit kaybetme.
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">
              Marka, model, yıl ve parçayı gönder. Elinde liste veya fotoğraf
              varsa mesajına ekle.
            </p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="WhatsApp'tan acil oto yedek parça sor"
